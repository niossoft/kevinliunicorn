package com.kevinliunicorn.reflect;
...
public class reflectTest {
	...
	/**	 * Demo2: 验证所有的类都是Class类的实例对象	 * @throws ClassNotFoundException 	 */	
	public static void Demo2() throws ClassNotFoundException	{		
		//定义两个类型都未知的Class , 设置初值为null, 看看如何给它们赋值成Person类		
		Class<?> class1 = null;        
		Class<?> class2 = null;                
		//写法1, 可能抛出 ClassNotFoundException [多用这个写法]        
		class1 = Class.forName("com.kevinliunicorn.Person");        
	...
	public static void Demo6() throws ClassNotFoundException	{		
		Class<?> class1 = null;		
		class1 = Class.forName("com.kevinliunicorn.SuperMan");				
		//取得父类名称		
	...
	/*本文来自 胖虎 的CSDN 博客 ，全文地址请点击：https://blog.csdn.net/ljphhj/article/details/12858767?utm_source=copy*/ 
